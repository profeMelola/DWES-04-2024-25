...
public class FabricantesJPAServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("************* URL1: "+request.getContextPath());
        System.out.println("************* URL2: "+getServletContext().getContextPath());

        //getServletContext().getRequestDispatcher("/fabricantes.jsp").forward(request, response);
        getServletContext().getRequestDispatcher("/reports/fabricantes.xhtml").forward(request, response);
