...
public class Author {
    ...
    public void addBook(Book book) {
        // BUG, AÑADO Y NO COMPRUEBO QUE YA EXISTA....
        books.add(book);
        book.setAuthor(this);
    }
    ...
    // -------------- DOS OBJETOS AUTHOR SON IGUALES SI COINCIDE EL NOMBRE ---------------
    @Override
    public int hashCode() {
        final int prime = 31;
        int result = 1;
    ...
    public boolean equals(Object obj) {
        ...
        if (name == null) {
            if (other.name != null)
                return false;
        } else if (!name.equalsIgnoreCase(other.name)) //He añadido que no sea case sensitive
            return false;
        return true;
    }
